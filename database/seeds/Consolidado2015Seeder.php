...
class Consolidado2015Seeder extends Seeder
{
    /**
    ...
    public function run()
    {
      $table      = "consolidado2015s";
      $file_path  = base_path() . "/data/consolidado_2015_utf8.csv";
      ...
      $this->command->info('Consolidado 2015 table seeded!');
        //
    }
}
